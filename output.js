//Thu Oct 03 2024 07:58:47 GMT+0000 (Coordinated Universal Time)
  ...
  try {
    {
      ...
      const _0x323554 = _0xbb763f;
      return new Promise(_0x45067b => {
        $.get(_0x323554, async (_0x289d2a, _0x158534, _0x2314a5) => {
          {
            try {
              {
  ...
  try {
    {
      ...
      return new Promise(_0xf96cda => {
        $.get(_0x565cdd, async (_0x28f6f9, _0x1c66c4, _0x5830a6) => {
          {
            try {
              {
  ...
  try {
    {
      ...
      return new Promise(_0x571a58 => {
        {
          $.get(_0x23bf0b, async (_0x4a3d8b, _0x38fed9, _0x190afc) => {
            {
              try {
                {
...
function Env(_0x100d90, _0x13c3f7) {
  ...
  return new class {
        ...
        {
          {
            ...
            const _0x18aacb = this.path.resolve(process.cwd(), this.dataFile);
            const _0x44a3cc = this.fs.existsSync(_0x2595be);
            const _0xa01581 = !_0x44a3cc && this.fs.existsSync(_0x18aacb);
        ...
        if (this.isNode()) {
          {
            ...
            const _0x44948 = this.path.resolve(process.cwd(), this.dataFile);
            const _0x48bccd = this.fs.existsSync(_0x331b10);
            const _0x17e4b4 = !_0x48bccd && this.fs.existsSync(_0x44948);
            const _0xeafc5d = JSON.stringify(this.data);
    ...
    lodash_get(_0x42790f, _0x15f84c, _0x2508df) {
      {
        ...
        for (const _0x77e9bb of _0x1c6ba3) if (_0x287c34 = Object(_0x287c34)[_0x77e9bb], undefined === _0x287c34) {
          return _0x2508df;
        }
        return _0x287c34;
      }
        ...
        if (/^@/.test(_0x1898f4)) {
          {
            ...
            const _0x3df896 = _0x2a97a6 ? this.getval(_0x2a97a6) : "";
            if (_0x3df896) {
              try {
                {
        ...
        if (/^@/.test(_0x565c07)) {
          {
            ...
            const _0x5870e3 = this.getval(_0x37775d);
            const _0x4056e2 = _0x37775d ? "null" === _0x5870e3 ? null : _0x5870e3 || "{}" : "{}";
            try {
              {
    ...
    initGotEnv(_0x285d3b) {
      {
        ...
        _0x285d3b && (_0x285d3b.headers = _0x285d3b.headers ? _0x285d3b.headers : {}, undefined === _0x285d3b.headers.Cookie && undefined === _0x285d3b.cookieJar && (_0x285d3b.cookieJar = this.ckjar));
      }
    }
          ...
          case "Node.js":
            ...
            this.got(_0x313672).on("redirect", (_0xc1fc9c, _0x303ef0) => {
            ...
            }).then(_0x678a5b => {
              {
                ...
                const _0x436b54 = _0x22b29f.decode(_0x464827, this.encoding);
                const _0x5d1ae6 = {
                  status: _0x3a8014,
                  statusCode: _0x5e1408,
                  headers: _0x1312fc,
            ...
            this.got[_0x1a4f1a](_0x2653c1, _0x4a0e6e).then(_0x5680bc => {
              {
                ...
                const _0x1be072 = _0x34f4c5.decode(_0x2389d1, this.encoding);
                const _0x90c121 = {
                  status: _0x3318db,
                  statusCode: _0x1d39b4,
                  headers: _0x53fda1,
              ...
              case "Loon":
                {
                  ...
                  let _0x18490e = _0xc608.mediaUrl || _0xc608["media-url"];
                  const _0xd80413 = {
                    openUrl: _0x5d15de,
                    mediaUrl: _0x18490e
                  };
              ...
              case "Quantumult X":
                {
                  ...
                  let _0x4a8cf7 = _0xc608["media-url"] || _0xc608.mediaUrl;
                  let _0x378cb2 = _0xc608["update-pasteboard"] || _0xc608.updatePasteboard;
                  const _0x5731f8 = {
                    "open-url": _0x382a1d,
                    "media-url": _0x4a8cf7,
    ...
    wait(_0x51be2a) {
      ...
      const _0x16fed1 = (_0x433eb5 - this.startTime) / 1000;
